...
def plot2D(data, hull, pause=False, pauseDuration=0.0000001):
    plt.clf()
...
def plotLinesAndPointsInStep(L, P, pauseDuration=0.0000001):
    ...
    plt.pause(pauseDuration)	# Mini-pause before closing plot